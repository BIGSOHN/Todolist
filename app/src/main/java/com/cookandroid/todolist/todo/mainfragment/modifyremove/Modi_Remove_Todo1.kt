...
import com.cookandroid.todolist.databinding.ActivityModiRemoveTodoBinding
...
class Modi_Remove_Todo1 : AppCompatActivity() {

    private lateinit var binding : ActivityModiRemoveTodoBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_modi_remove_todo)

        todoViewModel = ViewModelProvider(this).get(TodoViewModel::class.java)
        todoViewModel.getCate1Data()

        val position = intent.getIntExtra("todoPosition", 0)
