...
class Modi_Remove_Todo2 : AppCompatActivity() {

    private lateinit var binding : ActivityModiRemoveTodo2Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_modi_remove_todo2)

        todoViewModel = ViewModelProvider(this).get(TodoViewModel::class.java)
        todoViewModel.getCate2Data()

        val position = intent.getIntExtra("todoPosition2", 0)
