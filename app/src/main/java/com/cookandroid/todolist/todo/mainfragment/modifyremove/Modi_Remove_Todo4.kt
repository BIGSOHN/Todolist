...
import com.cookandroid.todolist.databinding.ActivityModiRemoveTodo4Binding
...
class Modi_Remove_Todo4 : AppCompatActivity() {

    private lateinit var binding : ActivityModiRemoveTodo4Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_modi_remove_todo4)

        todoViewModel = ViewModelProvider(this).get(TodoViewModel::class.java)
        todoViewModel.getCate4Data()

        val position = intent.getIntExtra("todoPosition4", 0)
